...
\begin{frame}{Antecedentes teóricos}
    La ley de flexión nos dice que la luz que incide sobre una superficie plana a un ángulo $\theta_i$ con respecto a la normal a la superficie es reflejada en un ángulo $\theta_r$, el cual es igual al ángulo incidente. Es decir, se cumple que $\theta_i=\theta_r$. Ver figura \ref{fig:Reflexion}.
\begin{figure}
    \begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=2.5cm,y=2.5cm]
        \clip(-0.6906385933154208,-0.26810554937897035) rectangle (0.6906385933154208,0.8880658841405272);
        \draw[line width=1pt,color=ffqqqq,smooth,samples=100,domain=-0.6906385933154208:0.6906385933154208] plot(\x,{2*abs((\x))});
        \draw [line width=0.5pt,dash pattern=on 1pt off 1pt] (0,-0.26810554937897035) -- (0,0.8880658841405272);
        \draw [line width=1pt,color=qqttcc,domain=-0.6906385933154208:0.6906385933154208] plot(\x,{(-0-0*\x)/1});
        \draw [shift={(0,0)},line width=1pt]  plot[domain=1.1071487177940904:2.0344439357957027,variable=\t]({1*0.4954902747280365*cos(\t r)+0*0.4954902747280365*sin(\t r)},{0*0.4954902747280365*cos(\t r)+1*0.4954902747280365*sin(\t r)});
        \begin{scriptsize}
        \draw[color=black] (0.1,0.35) node {$\theta_r$};
        \draw[color=black] (-0.1,0.35) node {$\theta_i$};
        \end{scriptsize}
    \end{tikzpicture}

    \caption{Esquema de la ley de reflexión}
    \label{fig:Reflexion}
\end{figure}
\end{frame}
...
\begin{frame}{Antecedentes teóricos}
    En la figura \ref{fig:Esquema} se muestran los puntos $A, B$ y $C$ que representan el punto de incidencia, el punto de reflexión y el punto de observación respectivamente. Además, se muestra la dirección del haz del láser, la normal a la superficie y los ángulos de incidencia y reflexión. Tomamos $\Delta\theta=\theta_r-\theta_0$  
    ...
    \begin{figure}
        \begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=0.3cm,y=0.3cm]
            ...
            \draw[color=rvwvcq] (10.0,-2.7) node {Espejo};
            ...
            \draw[color=black] (7.81530904118649,-1) node {$\theta_{r}$};
            \draw[color=black] (7,-6.525154907687348) node {$\theta_r$};
            \end{scriptsize}
        \end{tikzpicture}
