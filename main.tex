...
\begin{minipage}{.45\textwidth}
    En la gráfica se observa que los puntos se encuentran sobre la línea $y=x$, lo cual es consistente con la ley de reflexión, ya que el ángulo de incidencia es igual al ángulo de reflexión. Podemos concluír que los resultados obtenidos son consistentes con la ley de reflexión.
\end{minipage}
\hfill
