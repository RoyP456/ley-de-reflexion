...
\begin{frame}{Fuentes de error}
    Con ayuda de las tablas y de la gráfica se puede notar que el error no excede 1 grado, lo cual es un error bastante pequeño. Sin embargo, existen algunas fuentes de error que podrían haber afectado los resultados, entre ellas se encuentran: \\
    \begin{enumerate}
